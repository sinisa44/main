...
try {
    ...
    $mail->Username   = 'webstranice2020@gmail.com';                     // SMTP username
    $mail->Password   = 'nimirobibusiness2020';                               // SMTP password
    $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('webstranice2020@gmail.com', 'EMAIL VERIFICATION');
